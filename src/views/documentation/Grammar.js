          ...
          content: [
            {
              type: "text",
              content:
                "<code>toEqual</code> 断言实际值是否等于接收到的值，如果它是一个对象，则断言是否具有相同的结构（递归进行比较）。",
            },
            {
              type: "codeBlock",
              language: "javascript",
      ...
      expect(testObj1).toEqual(testObj2); // 使用toStrictEqual用例将失败
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "使用 <code>not</code> 将否定断言。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `let input = Math.sqrt(16);
          ...
          content: [
            {
              type: "text",
              content:
                "<code>toContain</code> 断言实际值是否在数组中。<code>toContain</code> 还可以检查一个字符串是否是另一个字符串的子串。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("toContain", () => {
          ...
          content: [
            {
              type: "text",
              content:
                "<code>toThrowError</code> 断言函数在被调用时是否会抛出错误。",
            },
            {
              type: "text",
              content: "我们可以提供一个可选参数来测试是否抛出了特定的错误：",
            },
            {
              type: "list",
              content: [
            ...
            {
              type: "tip",
              content: "要测试异步函数，请与 rejects 结合使用。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("toThrowError", () => {
          ...
          content: [
            {
              type: "text",
              content:
                "这个断言对于测试函数是否被调用很有用。需要将一个 <code>spy</code> 函数传递给 expect。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("toHaveBeenCalled", () => {
  const obj = {
    testFunc() {},
  };
          ...
          content: [
            {
              type: "text",
              content:
                "这个断言检查函数被调用的次数是否达到特定次数。需要将一个 <code>spy</code> 函数传递给 expect。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `import { debounce } from "@/utils/utils.js";
      ...
      content: [
        {
          type: "text",
          content:
            "可提供测试使用功能的 vi 辅助工具。可以全局访问（启用 globals 配置），也可以直接从 vitest 中导入：",
        },
        {
          type: "codeBlock",
          language: "javascript",
          ...
          content: [
            {
              type: "text",
              content:
                "用另一个模块替换提供的 path 中的所有导入模块。对 vi.mock 的调用是悬挂式的，因此在何处调用并不重要。它总是在所有导入之前执行。",
            },
            {
              type: "tip",
              content:
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `import { RGBAtoRGB } from "@/utils/utils.js";
      ...
      return {
        ...
        RGBAtoRGB: vi.fn(() => 'mockRes'),
            ...
            },
            {
              type: "tip",
              content:
                "如果我们模拟的模块有默认导出，则需要在返回的工厂函数对象中提供一个 default 键。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `import testMock from "@/utils/testMock.js";
...
test("default module should be mocked", () => {
          ...
          content: [
            {
              type: "text",
              content:
                "创建函数的监视程序。每次调用函数时，它都会存储调用参数、返回值和实例。如果没有给出函数，调用时将返回 undefined。",
            },
            {
              type: "tip",
              content: "一般可用作callback函数。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("vi.fn", () => {
          ...
          content: [
            {
              type: "text",
              content:
                "创建与 <code>vi.fn()</code> 类似的对象的方法或 getter/setter 的监听(spy) 。它会返回一个 mock 函数 。",
            },
            {
              type: "tip",
              content: "一般可用在断言某一函数是否被调用。",
            },
            {
              type: "codeBlock",
              language: "javascript",
  ...
  test("vi.fn should be called", () => {
    ...
    expect(func).toHaveBeenCalled();
        ...
        },
        {
          ...
          value: "viUseFakeTimers",
          content: [
            {
              type: "text",
              content:
                "要启用模拟定时器，调用此方法。它将取代以下原始计时器函数的实现。（ <code>setTimeout</code> 、<code>setInterval</code> 、<code>clearTimeout</code> 、<code>clearInterval</code> 、<code>setImmediate</code> 、<code>clearImmediate</code> 和 <code>Date</code>）",
            },
            {
              type: "text",
              content: "使用<code>vi.useFakeTimers</code>的意义：",
            },
            {
              type: "text",
              content:
                "原生的计时器函数不是很方便测试，因为程序需要等待相应的延时。 Vitest可以通过一个函数转换计时器以便允许你控制时间。若测试用例当中含有较多需要异步等待的用例，使用Fake Time将会节省大量执行用例的时间。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("vi.useFakeTimers", () => {
  test("time should be faked", async () => {
    ...
    expect(count).toBe(5);
            ...
            {
              type: "img",
              content: "useFakeTime.png",
              style: "width:40%",
            },
            {
              type: "text",
              content: "若不使用Fake Time，用例执行可能会花费更长的时间：",
            },
            {
              type: "codeBlock",
              language: "javascript",
  ...
  test("time should be faked", async () => {
    ...
    expect(count).toBe(5);
            ...
            {
              type: "img",
              content: "useRealTime.png",
              style: "width:40%",
            },
          ],
        },
        {
          title: "vi.advanceTimersByTime",
          value: "viAdvanceTimersByTime",
          content: [
            {
              type: "text",
              content:
                "通过调用这个API， 所有计时器都将以毫秒增长。所有处于任务队列等待中的宏任务都将被执行。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("vi.advanceTimersByTime", () => {
  test("time should be faked", async () => {
      ...
      content: [
        {
          type: "text",
          content:
            "前面介绍了Vitest相关基础语法。但要完成vue工程的单元测试，还需要有对组件进行测试的方法。",
        },
        {
          type: "text",
          content:
            '在vue项目中，若使用的风格是<a href="https://vuejs.org/guide/introduction.html#api-styles" target="_blank">选项式API</a>，则支持直接引入该组件暴露出的对象，获取其中的方法。',
        },
        {
          type: "codeBlock",
          language: "vue",
    ...
    changeTest(value) {
      this.test = value;
        ...
        },
        {
          type: "codeBlock",
          language: "javascript",
          content: `import OptionsApi from "@/components/OptionsApi.vue";
      ...
      content: [
        {
          type: "text",
          content:
            "Vue Test Utils 是 Vue.js 官方的单元测试实用工具库。可用于vue组件测试。",
        },
        {
          type: "text",
          content: "首先进行安装",
        },
        {
          type: "codeBlock",
          language: "bash",
          content: `npm install -D @vue/test-utils`,
        },
        {
          type: "text",
          content: "基础用法",
          ...
          content: [
            {
              type: "text",
              content:
                "用于渲染vue组件，并将挂载后的组件赋值给包裹器<code>wrapper</code>",
            },
            {
              type: "text",
              content:
                "其中 <code>wrapper</code> 是一个对象，该对象包含了一个挂载的组件或 vnode，以及测试该组件或 vnode 的方法。",
            },
            {
              type: "codeBlock",
              language: "vue",
...
describe("Home", () => {
          ...
          content: [
            {
              type: "text",
              content:
                "<code>wrapper.vm</code> 为组件vue实例。你可以通过 <code>wrapper.vm</code> 访问一个实例所有的方法和属性。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test("waveShow should be changed", () => {
  ...
  expect(wrapper.vm.waveShow).toBe(false);
        ...
        {
          title: "wrapper.emitted()",
          value: "wrapperEmitted",
          content: [
            {
              type: "text",
              content: "返回一个包含所有触发的自定义事件的对象。",
            },
            {
              type: "tip",
              content: "可用于断言事件是否发送",
...
function fireEvent(params) {
  emit("fireEvent", params);
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test("event should be emitted", () => {
  const wrapper = mount(TestComponent);
  ...
  expect(wrapper.emitted().fireEvent.length).toBe(2); // { fireEvent: [["param1"], ["param2"]] }
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "返回wrapper的文本内容，将所有的innerText合并并返回",
            },
            {
              type: "codeBlock",
              language: "html",
  ...
  <div class="test-component">
    ...
    <div class="text">testcase</div>
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test("wrapper text should contain vitest", () => {
  const wrapper = mount(TestComponent);
  ...
  expect(wrapper.text()).toContain('vitest')
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "返回 Wrapper DOM 节点的 HTML 字符串。",
            },
            {
              type: "codeBlock",
              language: "javascript",
  ...
  expect(wrapper.html()).toContain('<div class="text">vitest</div>')
        ...
        {
          title: "wrapper.setData",
          value: "wrapperSetData",
          content: [
            {
              type: "text",
              content: "设置 Wrapper vm 的属性。",
            },
            {
              type: "codeBlock",
              language: "javascript",
  ...
  test("data should be changed", async () => {
    ...
    expect(wrapper.vm.test).toBe("abc");
            ...
            },
            {
              type: "tip",
              content:
                "若使用组合式API，无法使用setData，无法修改setup中的数据",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "text",
              content:
                "和 <code>mount</code> 一样，创建一个包含被挂载和渲染的 Vue 组件的 Wrapper，不同的是<b>子组件不会被渲染</b>。",
            },
            {
              type: "codeBlock",
              language: "vue",
    ...
    rgb(80, 110, 16);">
          <div data-v-5b0fc2a0="" class="Documentation">
            ...
            },
            {
              type: "text",
              content:
                "由此可以看出，使用mount会将组件内包含的子组件全部渲染出来，组件层级越深，渲染的花销和不确定性就越大，因此，建议渲染组件时以使用<code>shallowMount</code>为主。",
            },
            {
              type: "tip",
              content: `在测试用例中，我们通常希望专注在一个孤立的单元中测试组件，避免对其子组件的行为进行间接的断言。额外的，对于包含许多子组件的组件来说，整个渲染树可能会非常大。重复渲染所有的子组件可能会让我们的测试变慢。`,
            },
          ],
        },
      ],
      ...
      content: [
        {
          type: "text",
          content:
            "包括 <code>mount</code> 和 <code>shallowMount</code> 的可供传递的选项。",
        },
      ],
      children: [
        {
          ...
          content: [
            {
              type: "text",
              content: "向一个组件传入数据。这将会合并到现有的 data 函数中。",
            },
            {
              type: "codeBlock",
              language: "vue",
    ...
    changeTest(value) {
      this.test = value;
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test("test data should be changed", async () => {
  ...
  expect(wrapper.vm.test).toBe("123");
        ...
        },
        {
          ...
          content: [
            {
              type: "text",
              content: "在组件被挂载时设置组件实例的 prop。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("optionData", () => {
...
watch(
  ...
  { immediate: true }
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test("prop data should changed", async () => {
  const wrapper = shallowMount(TestComponent, {
    props: {
      testProp:'res'
    },
  ...
  <div class="test-component">
    ...
    <slot></slot>
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test("slots should be inserted", async () => {
  const wrapper = mount(TestComponent, {
    slots: {
          ...
          content: [
            {
              type: "text",
              content:
                "mock一个全局的实例属性。一般可用于mock <code>this.$store</code> <code>this.$router</code>等",
            },
            {
              type: "codeBlock",
              language: "vue",
  ...
  expect($store.dispatch).toHaveBeenCalledWith('click')
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: "tip",
              content: "常用于挂载第三方组件，如element-plus",
            },
            {
              type: "codeBlock",
              language: "javascript",
          ...
          content: [
            {
              type: "text",
              content:
                "jest 当中，用例支持传递一个 done 参数，jest会等done回调函数被调用执行结束后，再结束测试。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test('the data should be peanut butter', done => {
  function fetchData() {
  ...
  fetchData().then(res => {
    expect(res).toBe('peanut butter');
            ...
            },
            {
              type: "text",
              content:
                "但在Vitest中不允许这么做，从 Vitest v0.10.0 开始，声明测试的回调样式被弃用。官方建议你使用async/await",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test('the data is peanut butter', async () => {
          ...
          content: [
            {
              type: "text",
              content:
                "以axios为例，若我们需要模拟接口返回的数据，可以使用Vitest模块mock工具：<code>vi.mock</code>",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `vi.mock('axios', () => {
  return {
    default: {
      post: vi.fn(),
      get: vi.fn(),
        ...
        response: {
          ...
          reject: vi.fn(),
            ...
            },
            {
              type: "text",
              content:
                '之后使用 <code>mockResolvedValueOnce</code> 模拟一次接口调用的数据：<a href="https://cn.vitest.dev/api/mock.html#mockResolvedValueOnce" target="_blank">mockResolvedValueOnce</a>',
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `mocks.get.mockResolvedValueOnce({
  data: {},
});`,
            },
            {
              type: "text",
              content:
                '这里推荐一个比较好用的接口mock管理工具：<a href="https://www.npmjs.com/package/axios-mock-adapter?activeTab=readme" target="_blank">axios-mock-adapter</a>',
            },
            {
              type: "codeBlock",
              language: "javascript",
...
mock.onGet("/users").reply(200, {
  users: [{ id: 1, name: "John Smith" }],
            ...
            },
            {
              type: "text",
              content:
                "需要注意的是，如果接口mock了参数，调用接口时，传参需要完全一致，否则无法调通。",
            },
          ],
        },
      ],
    ...
    {
      title: "测试用例编写最佳实践",
      value: "testCaseBestPractice",
      content: [
        {
          type: "text",
          content:
            '<a href="https://blog.logrocket.com/javascript-testing-best-practices/" target="_blank">JavaScript testing: 9 best practices to learn</a>',
        },
      ],
      children: [
        {
          title: "写好测试注释和描述",
          value: "writeTestDescription",
          content: [
            {
              type: "text",
              content:
                "测试用例和实际业务代码一样，如果没有简介准确的注释，都将使代码难以阅读和维护。",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: "text",
              content:
                "AAA模式表示的是Arrange（安排）, Act（行动）, 和 Assert（断言），这是写所有测试用例的必要三步骤，简而言之，即：",
            },
            {
              type: "list",
              content: [
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `test('should return max number', () => {
  // Arrange
  let Arr = [1, 10, 5, 9, 8];
  ...
  expect(res).toBe(10);
            ...
            },
            {
              type: "text",
              content:
                "任何一个测试用例都可以套用该模式，当你不知道该如何对一段代码设计测试用例时，可以尝试使用该模式入手。只要记住一点，待测的代码段一定进行了某些操作，结果便是：或改变了某个值，或调用了某个方法。否则该待测的代码将不存在价值。",
            },
          ],
        },
        {
  ...
  describe('formatDate', () => { // 第2层
    test('res date format should match YYYY-MM-DD HH:mm:ss', () => { // 第3层
        ...
        {
          title: "避免在测试中捕捉错误",
          value: "avoidCatchError",
          content: [
            {
              type: "text",
              content:
                "尽可能避免在测试中使用 <code>try...catch</code> 语句，如果你在试图测试的函数的逻辑中存在错误，那有可能导致用例失效。最后测试虽然通过了，但业务逻辑是错误的。",
            },
            {
              type: "text",
              content:
                "下面的代码段，addNewProduct表示添加新商品，如果新商品没有传价格，将会报错。现假设addNewProduct函数内部存在逻辑错误，而此时测试用例恰好没有传价格参数，此时会进入到catch当中并调用callback函数。",
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `addNewProduct(productInfo) {
  return new Promise((resolve, reject) => {
    if (productInfo && productInfo.price) {
      ...
      reject("No product price");
            ...
            },
            {
              type: "codeBlock",
              language: "javascript",
              content: `describe("addNewProduct", () => {
        ...
        },
        {
          ...
          content: [
            ...
            },
            {
              type: "text",
              content:
                "一般来说，你应该只模拟最底层的依赖关系和I/O操作，比如API数据的调用",
            },
          ],
        },
        {
          ...
          content: [
            {
              type: 'text',
              content: '创建测试数据的时候，尽量还原真实数据，以覆盖尽可能多的分支来检测可能存在的缺陷。',
            },
            {
              type: 'text',
              content: '简而言之，尽量不要使用典型的 <code>foo</code> 字符串来测试你的代码。',
            },
          ]
        },
        {
          title: '避免测试有太多的断言',
          value: 'avoidTooMuchAssert',
          content: [
            {
              type: 'text',
              content: '不要觉得拆分场景或写更具体的测试描述麻烦。一个测试用例包含五个以上的断言应该视作一条红线，它表明你试图一次性验证太多的东西。',
            },
            {
              type: 'text',
              content: '换句话说，你的测试描述还不够具体。另外，通过编写更具体的测试用例，开发人员在进行代码更新时，也会更容易识别需要修改的测试。',
            },
          ]
        },
      ],
